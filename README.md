...
4. In `edit.php`, set `$windowerUrl` to full URL address directed exactly to `.../Windower/` directory and `require_once` to full PATH directed to `...\\Windower\\config.php` file (`.../Windower/config.php` on Linux).
